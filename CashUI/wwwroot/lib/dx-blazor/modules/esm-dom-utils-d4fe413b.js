...
function CloneObject(srcObject) {
    ...
    var isScrollBodyIE = Browser.IE && GetCurrentStyle(document.body).overflow == "hidden" && document.body.scrollLeft > 0;
    ...
    var isScrollBodyIE = Browser.IE && GetCurrentStyle(document.body).overflow == "hidden" && document.body.scrollTop > 0;
...
export { AddClassNameToElement, AttachEventToElement, CancelAnimationFrame, CloneObject, CreateStyleSheetInDocument, DetachEventFromElement, ElementHasCssClass, EnsureElement, FocusElement, GetAbsolutePositionX, GetAbsolutePositionY, GetAbsoluteX, GetAbsoluteY, GetClassName, GetClassNameList, GetCurrentStyle, GetCurrentStyleSheet, GetDocumentClientHeight, GetDocumentClientWidth, GetDocumentScrollLeft, GetDocumentScrollTop, GetHorizontalBordersWidth, GetLeftRightBordersAndPaddingsSummaryValue, GetLeftRightPaddings, GetNodeByTagName, GetNodesByTagName, GetParentByClassName, GetPositionElementOffset, GetTopBottomBordersAndPaddingsSummaryValue, GetTopBottomPaddings, GetVerticalBordersWidth, GetVerticalScrollBarWidth, Log, PrepareClientPosForElement, PreventEvent, PreventEventAndBubble, QuerySelectorFromRoot, RemoveClassNameFromElement, RequestAnimationFrame, RetrieveByPredicate, SetAbsoluteX, SetAbsoluteY, SetAttribute, SetCheckInputIndeterminate, SetClassName, SetInputAttribute, SetStylesCore, applyStateToElement, applyStyles, calculateStyles, changeDom, clearStyles, createElementState, elementIsInDOM, findParentBySelector, getDocumentScrollLeft, getDocumentScrollTop, nextChangeDOM, setCssClassName, setStyles, subscribeElementContentSize, subscribeElementContentWidth, subscribeElementDisconnected, toggleCssClass, updateAttribute, updateElementState };
